...
%prep
%setup -q -n unison-%{ver_maj}.%{ver_min}.%{ver_patch}
...
%changelog
* Thu Oct 27 2022 Nicholas Kudriavtsev <nkudriavtsev@gmail.com> - 2.52.1-1
- Update to 2.52.1

* Sun Jun 27 2021 Nicholas Kudriavtsev <nkudriavtsev@gmail.com> - 2.51.4-1
- Update to 2.51.4
